        ...
        <li>
            <div class="btn-group">
                <button class="btn btn-default dropdown-toggle" data-toggle="dropdown" type="button">
                    ...
                    As <?php echo $_SESSION['system']['nama_lengkap'];?>
                ...
                <ul class="dropdown-menu dropdown-menu-right">
                    ...
                    <li>
                        <a tabindex="-1" href='#' onClick="click_menu('inc/login_action.php?lockscreen=1&username=<?php echo $_SESSION['system']['username'];?>','Home');">
                            <i class="si si-lock pull-right"></i>Lock Account
                        </a>
                    </li>
                    <li>
                        <a tabindex="-1" href='#' onClick="click_menu('inc/login_action.php?logout=1','Home');">
