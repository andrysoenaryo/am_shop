...
<div class="block">
    ...
    <div class="block-content tab-content">
        <div class="tab-pane active" id="tab-list">
            <div class="table-responsive"><table id="table_upk" ></table></div>
        </div>
...
<script>
$('#table_upk').bootstrapTable({
	url				: 'master/model/mod_upk.php',
	method			: 'get',
    dataType		: 'json',
	queryParams		: {
						grid_table	: 1,
...
{
	var URL = 'master/model/mod_upk.php';
	var act = act;
	if(act=='back')
	{
		backTabs();
...
$(function(){
  var items="";
  $.getJSON("master/model/mod_upk.php?select=class_icon",function(data){
...
$(function(){
  var items="";
  $.getJSON("master/model/mod_upk.php?select=parent_menu",function(data){
	  items+="<option value=''></option>";
	$.each(data,function(index,item) 
	{
