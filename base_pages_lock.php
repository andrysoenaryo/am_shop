            ...
            <div class="block block-themed animated bounceIn">
                <div class="block-header bg-primary">
                    <ul class="block-options">
                        <li>
                            <a href="inc/login_action.php?logout=1&lock=1" data-toggle="tooltip" data-placement="left" title="Log in with another account">
                ...
                <div class="block-content block-content-full block-content-narrow">
                    ...
                    <form class="js-validation-lock form-horizontal push-30-t push-30" action="inc/login_action.php" method="post">
                        <div class="form-group">
                            <div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2">
                                <div class="form-material form-material-primary">
                                	<input id="username" name="username" type="hidden" value="<?php echo $_SESSION['system']['username'];?>">
